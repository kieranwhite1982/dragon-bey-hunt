...
export const STAGES = [
  {
    ...
    part: { key: 'ratchet', name: 'THE RATCHET', emoji: '⚙️', color: '#22d3ee' },
  ...
  },
  {
    ...
    part: { key: 'energy', name: 'THE ENERGY LAYER', emoji: '⚡', color: '#a3e635' },
  ...
  },
  {
    ...
    spotEmoji: '🪑',
    gift: 'Apitor Robot J',
    part: { key: 'chip', name: 'THE BIT CHIP', emoji: '🧠', color: '#ff2e63' },
  ...
  },
  {
    ...
    spotEmoji: '🛋️',
    gift: 'Small World',
    part: { key: 'disc', name: 'THE FORGE DISC', emoji: '💿', color: '#ffc94a' },
  ...
  },
  {
    ...
    spotEmoji: '🚗',
    gift: 'Smart Watch',
    part: { key: 'driver', name: 'THE DRAGON DRIVER', emoji: '🔥', color: '#ff6b35' },
