/* Optional asset slots (brief §11).
   ...
   named ignis-portrait.*, ignis-intro.* and wyrm-portrait.* and bakes the
   filename in as a define. Nothing is probed over the network, so the slots
   behave identically online and in flight mode, and the service worker
   precaches whatever is there like any other build output.
